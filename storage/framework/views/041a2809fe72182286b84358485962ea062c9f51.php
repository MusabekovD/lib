...
<body>
	...
	<div class="body">
		...
		<section class="main_news" style="padding: 50px 0;" >
			<?php echo $__env->make('frontend.news', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		</section>
				...
				<div class="row">
					...
					<div class="col-lg-3">
						<div class="indicator_block">
							...
							<div class="indicator_number"><?php echo e($booksCount, false); ?> ta</div>
					...
					<div class="col-lg-3">
						<div class="indicator_block">					
							...
							<div class="indicator_number"><?php echo e($membersCount, false); ?> ta</div>
					...
					<div class="col-lg-3">
						<div class="indicator_block">
							...
							<div class="indicator_number"><?php echo e($likesCount, false); ?> ta</div>
		...
		<section class="main_books" style="padding: 50px 0;" >
			<?php echo $__env->make('widgets.newlet', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		</section>
...
</html><?php /**PATH /var/www/resources/views/layouts/newmain.blade.php ENDPATH**/ ?>