          ...
          <div class="row">
              <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                  <div class="icon-box w-100" data-aos="fade-up" data-aos-delay="100">
                      ...
                      <h4 class="title"><a href=""><?php echo e($membersCount, false); ?> ta</a></h4>
              ...
              <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                  <div class="icon-box w-100" data-aos="fade-up" data-aos-delay="200">
                      ...
                      <h4 class="title"><a href=""><?php echo e($likesCount, false); ?> ta</a></h4>
              ...
              <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                  <div class="icon-box w-100" data-aos="fade-up" data-aos-delay="300">
                      ...
                      <h4 class="title"><a href=""><?php echo e($booksCount, false); ?> ta</a></h4>
...
<?php echo $__env->make('layouts.newmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/welcome.blade.php ENDPATH**/ ?>