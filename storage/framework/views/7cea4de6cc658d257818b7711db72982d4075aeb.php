            ...
            <div class="row">
                    ...
                    <div class="sidebar mb-5">
                        <ul>
                            ...
                            <?php $__currentLoopData = $cateOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cateOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li <?php if($cateOption['id'] == $id): ?> class="act" <?php endif; ?>>
                                    <div class="main-nav__drop-holder main-nav__drop-parent">
                                        <a href="javascript:void(0);" class="main-nav__drop-parent">
                                            ...
                                            <span> <?php echo e($cateOption['title'], false); ?> <span
                                                    class="badge rounded-pill bg-info text-dark"><?php echo e(CalculateCountHelper::calculateCount($cateOption['id']), false); ?></span></span>
                                        </a>
                                            ...
                                            <ul class="main-nav__drop-list">
                                                <?php for($i = 1; $i <= $cateOption['course']; $i++): ?>
                                                    <li class="main-nav__drop-item">
                                                        <a
                                                            href="/library_manual/<?php echo e($cateOption['id'], false); ?>?course=<?php echo e($i, false); ?>"><?php echo e($i, false); ?>

                                                            - kurs
                                                            <span
                                                                class="badge rounded-pill bg-info text-dark"><?php echo e(CalculateCountHelper::calculateCount($cateOption['id'], $i), false); ?></span></a>
                                                    </li>
                                                <?php endfor; ?>
                                            </ul>
                                        </div>
                ...
                <div class="col-lg-9">
                            ...
                            <article>
                                <div class="books_body">
                                    <div class="post-title"
                                        ...
                                        <a href="<?php echo e($books->getImage(), false); ?>"><?php echo e($books->title, false); ?></a>
                                    </div>
                                    <img src="<?php echo e($books->getImage(), false); ?>" class="books_image">
                                </div>
                                <div class="books_footer">
                                    <div class="books_date">
                                        <svg width="15" height="17" viewBox="0 0 15 17" fill="none"
                                            ...
                                            <path
                                                ...
                                                fill="#285BAD" />
                                        </svg> <?php echo e($books->b_published_year, false); ?>
                                    ...
                                    <div class="books_info"> <span class="me-3">
                                            ...
                                            <?php echo e($books->download_count, false); ?></span> <span>
                                            ...
                                            <?php echo e($books->view_count, false); ?></span></div>
                                </div>
                            </article>
                        </div>
                        <div class="col-lg-8 d-flex flex-wrap align-content-around">
                            <div class="block col-12">
                                <p><span class="fw-bold">ISBN:</span><?php echo e($books->isbn, false); ?></p>
                                <p><span class="fw-bold">Muallif:</span><?php echo e($books->muallif->name, false); ?></p>
                                <p><span class="fw-bold">Til:</span><?php echo e($books->lang->name, false); ?></p>
                                <p><span class="fw-bold">Yozuv:</span><?php echo e($books->read_lang(), false); ?></p>
                                <p><span class="fw-bold">Resurs turi:</span>Darslik</p>
                                <p><span class="fw-bold">Betlar soni:</span><?php echo e($books->b_page_count, false); ?></p>
                                <p><span class="fw-bold">Adadi:</span><?php echo e($books->b_publishing, false); ?></p>
                                <p><span class="fw-bold">Nashriyot:</span> <?php echo e($books->publishing->name, false); ?></p>
                                <p><span class="fw-bold">Nashr yili:</span> <?php echo e($books->b_published_year, false); ?></p>
                                <p><span class="fw-bold">Kurs:</span>
                                    <?php $__currentLoopData = $books->bookCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php echo e($course->course_id, false); ?> kurs,
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </p>
                                <p><span class="fw-bold">Kafedra:</span>
                                    <?php $__currentLoopData = $books->bookDepartments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php $__currentLoopData = $cateOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($dep['id'] == $department['department_id']): ?>
                                                <?php echo e($dep['title'], false); ?> <br />
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </p>
                            ...
                            <div class="post_buttons col-12">
                                <?php if(Auth::guard('students')->check() || Auth::guard('employees')->check()): ?>
                                    ...
                                    <!-- <div class="btn btn-primary ">
                                        ...
                                        <a href="<?php echo e(route('pdf.viewer', $books->id), false); ?>" target="_blank">Yuklab olish</a>
                                    </div> -->
                                    ...
                                    <div class="btn btn-secondary ">
                                        ...
                                        <a href="<?php echo e(route('pdf.viewer-manual', $books->id), false); ?>">Online o’qish</a>
                                    </div>
                                <?php else: ?>
                                    ...
                                    <div style="background-color: gray; border-color: gray" class="btn btn-secondary ">
                                        ...
                                        <a data-toggle="tooltip" data-placement="top" href="<?php echo e(route('pdf.viewer', $books->id), false); ?>"
                    ...
                    <div class="row">
                        <div class="post_desc">
                            <h5>Kitob tavsifi</h5>
                            <p> <?php echo e($books->desc, false); ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.newsingle', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/library/lesson/newview.blade.php ENDPATH**/ ?>