                ...
                <div class="col-md-3 mb-5 mb-lg-0">
                    <div class="list-group">
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="https://lib.jdpu.uz/library?category=<?php echo e($item->id, false); ?>"
                        ...
                        <div class="col-md-8 mb-5">
                            ...
                            <div class="d-flex">
                                <?php if(Auth::guard('students')->check() || Auth::guard('employees')->check()): ?>
                                    <a class="btn btn-primary mr-3" target="_blank" href="<?php echo e($books->getFile(), false); ?>"
...
<?php echo $__env->make('layouts.single', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/library/view.blade.php ENDPATH**/ ?>