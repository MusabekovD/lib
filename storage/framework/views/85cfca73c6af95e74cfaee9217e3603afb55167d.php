                            ...
                            <article>
                                <div class="books_body">
                                    <div class="post-title"
                                        style="width:100%; height:70px ; overflow-y:hidden ; text-transform:uppercase"> <a
                                            href="<?php echo e($books->getImage(), false); ?>"><?php echo e($books->title, false); ?></a> </div> <img
                                        src="<?php echo e($books->getImage(), false); ?>" class="books_image">
                                </div>
                            ...
                            <div class="post_buttons col-12">
                                <?php if(Auth::guard('students')->check() || Auth::guard('employees')->check()): ?>
                                    <!-- <div class="btn btn-primary ">
                                        ...
                                        <a href="<?php echo e($books->getFile(), false); ?>" target="_blank">Yuklab olish</a>
                                    </div> -->
                                    <div class="btn btn-secondary ">
                                        ...
                                        <a href="<?php echo e(route('pdf.viewer', $books->id), false); ?>">Online o’qish<?php echo e($books, false); ?></a>
                                    </div>
                                <?php else: ?>
                                    <!-- <div style="background-color: gray; border-color: gray" class="btn btn-primary ">
                                        ...
                                        <a href="#" data-toggle="tooltip" data-placement="top"
                                            title="Yuklash uchun tizimga kiring">Yuklab olish</a>
                                    </div>
...
<?php echo $__env->make('layouts.newsingle', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/library/newview.blade.php ENDPATH**/ ?>