...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 mb-3">
            <article>
                <a  href="<?php echo e(route('viewbook', ['id' => $item->id]), false); ?>">
                <div class="books_body">
                    ...
                    <img src="<?php echo e($item->getImage(), false); ?>" class="books_image img-fluid">
                </div>
                </a>
                <div class="books_footer">
                    ...
                    <?php echo e($item->b_published_year, false); ?></div>
                    <div class="books_info">
                        ...
                        <?php echo e($item->download_count, false); ?></span>
                        <span>
...
<?php /**PATH /var/www/resources/views/widgets/newlet.blade.php ENDPATH**/ ?>