                           ...
                           <a href="https://lib.jdpu.uz/library?category=<?php echo e($item->id, false); ?>">
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_90_1140)">
                                    <path d="M14.625 15.375H3.375C2.88496 15.381 2.4125 15.1926 2.06107 14.851C1.70965 14.5094 1.5079 14.0425 1.5 13.5525V4.44749C1.5079 3.95747 1.70965 3.49055 2.06107 3.14897C2.4125 2.80738 2.88496 2.61897 3.375 2.62499H6.825C6.93578 2.62572 7.04502 2.65098 7.14487 2.69897C7.24473 2.74695 7.33271 2.81645 7.4025 2.90249L9.3525 5.28749H14.6025C14.847 5.28151 15.0903 5.32403 15.3183 5.41257C15.5463 5.50112 15.7546 5.63394 15.931 5.80338C16.1074 5.97282 16.2485 6.17552 16.3462 6.39978C16.4438 6.62404 16.4961 6.86542 16.5 7.10999V13.5525C16.4921 14.0425 16.2903 14.5094 15.9389 14.851C15.5875 15.1926 15.115 15.381 14.625 15.375Z" fill="#2B2B2B" /> </g>
                            </svg> <span> <?php echo e($item->name, false); ?></span><span>(<?php echo e($item->books_count, false); ?>)</span>
                           </a>
                        </li>
                            ...
                            <article>
                                ...
                                <div class="books_footer">
                                    ...
                                    <div class="books_info"> <span class="me-3">
                                        ...
                                        <?php echo e($item->download_count, false); ?></span> <span>
                                            ...
                                            <?php echo e($item->view_count, false); ?></span> </div>
                                </div>
                            </article>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?>
                    <h1 class="text-center">Ma'lumotlar topilmadi.</h1>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.newsingle', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/frontend/search.blade.php ENDPATH**/ ?>