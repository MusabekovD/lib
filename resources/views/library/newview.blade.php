                    ...
                    <div class="sidebar mb-5">
                        <ul>
                            @foreach ($categories as $item)
                                <li>
                                    <a href="/library?category={{ $item->id }}">
                                        ...
                                        </svg> <span> {{ $item->name }}</span><span>({{ $item->books_count }})</span>
                                    </a>
                                </li>
                            @endforeach
                        </ul>
                                ...
                                <div class="books_body">
                                    <div class="post-title"
                                        style="width:100%; height:70px ; overflow-y:hidden ; text-transform:uppercase"> <a
                                            href="{{ $books->getImage() }}">{{ $books->title }}</a> </div> <img
                                        src="{{ $books->getImage() }}" class="books_image">
                                </div>
                            ...
                            <div class="post_buttons col-12">
                                @if (Auth::guard('students')->check() || Auth::guard('employees')->check())
                                    <!-- <div class="btn btn-primary ">
                                        ...
                                        <a href="{{ $books->getFile() }}" target="_blank">Yuklab olish</a>
                                    </div> -->
                                    <div class="btn btn-secondary ">
                                        ...
                                        <a href="{{ route('pdf.viewer', $books->id) }}">Online o’qish{{$books}}</a>
                                    </div>
                                @else
